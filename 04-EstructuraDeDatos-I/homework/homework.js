...
function nFactorial(n) {
  if(n === 1 || n === 0) {    // matematicamente 1! = 1 y 0! = 1
    return 1;
  }
...
Queue.prototype.enqueue = function(algo){
  this.arreglo.push(algo);
}

Queue.prototype.dequeue = function(){
  
    return this.arreglo.shift();   // si no hay nada, shift() devuelve un undefined
}
...
//   enqueue(value) { this.unArray.push(value); }

//   dequeue() {
//     if (this.estaVacio()) {  return undefined;   }
//     return this.unArray.shift();  
//   }

//   size() {  return this.unArray.length; }

//   estaVacio() {  return this.size() === 0; }
// }
